...
public class chatConfig {
    ...
    public static String strategistTypeOne = ChatFormatting.DARK_BLUE + "\u22C8";
    public static String chiefTypeOne = ChatFormatting.LIGHT_PURPLE + "\u2748";
    public static String leaderTypeOne = ChatFormatting.DARK_PURPLE + "\u2742";
    public static String recruitTypeTwo = ChatFormatting.GREEN + "[RECRUIT]";
    public static String recruiterTypeTwo = ChatFormatting.AQUA + "[RECRUITER]";
    public static String captainTypeTwo = ChatFormatting.BLUE + "[CAPTN]";
    public static String strategistTypeTwo = ChatFormatting.DARK_BLUE + "[STRAT]";
    public static String chiefTypeTwo = ChatFormatting.LIGHT_PURPLE + "[CHIEF]";
    public static String leaderTypeTwo = ChatFormatting.DARK_PURPLE + "[LEADER]";
